...
void Config::SaveConfig()
{
	...
	WriteInt(("RageBot"), ("AutoRevolvo"), Clientvariables->Ragebot.AutomaticRevolver);
	...
	WriteInt(("Ragebot"), ("itemz2"), Clientvariables->Ragebot.multimemez2);
	WriteInt(("Ragebot"), ("itemz"), Clientvariables->Ragebot.multimemez);
	WriteInt(("Ragebot"), ("headaimwalking"), Clientvariables->Ragebot.headaimwalking);
	//Antiaims
	...
	WriteInt(("AntiAim"), ("breakaa"), Clientvariables->Antiaim.breakaa);
	...
	WriteInt(("AntiAim"), ("Lines"), Clientvariables->Antiaim.Lines);
	WriteInt(("AntiAim"), ("Indicator"), Clientvariables->Antiaim.Indicator);
	...
	WriteInt(("Visuals"), ("Lplayer"), Clientvariables->Visuals.ChamsL);
	WriteInt(("Visuals"), ("Glow"), Clientvariables->Visuals.Glow);
	WriteInt(("Visuals"), ("Radar"), Clientvariables->Visuals.Radar);
	...
	WriteInt(("Visuals"), ("crosssnip"), Clientvariables->Visuals.crosssnip);
	WriteInt(("Visuals"), ("asusprops"), Clientvariables->Colors.Props);
	...
	//	WriteInt(("Miscellaneous"), ("BacktrackVisual"), Clientvariables->Visuals.ShowBacktrack);
	...
	WriteInt(("Miscellaneous"), ("WireHand"), Clientvariables->Misc.WireHand);
	WriteInt(("Miscellaneous"), ("static_scope"), Clientvariables->Misc.static_scope);
	WriteInt(("Visuals"), ("Spectators"), Clientvariables->Visuals.Spectators);
	//Menu
	...
	WriteFloat(("Colors"), ("GlowA"), Clientvariables->Colors.Glow[3]);
	...
	WriteFloat(("Colors"), ("SpreadA"), Clientvariables->Colors.SpreadCrosshair[3]);
	...
	WriteFloat(("Colors"), ("ChamsHistoryR"), Clientvariables->Colors.ChamsHistory[0]);
	WriteFloat(("Colors"), ("ChamsHistoryG"), Clientvariables->Colors.ChamsHistory[1]);
	WriteFloat(("Colors"), ("ChamsHistoryB"), Clientvariables->Colors.ChamsHistory[2]);
}
...
void Config::LoadConfig()
{
	...
	Clientvariables->Ragebot.AutomaticRevolver = ReadInt(("RageBot"), ("AutoRevolvo"), 0);
	...
	Clientvariables->Ragebot.headaimwalking = ReadInt(("Ragebot"), ("headaimwalking"), 0);
	...
	Clientvariables->Ragebot.multimemez2 = ReadInt(("Ragebot"), ("itemz2"), 0);
	Clientvariables->Ragebot.multimemez = ReadInt(("Ragebot"), ("itemz"), 0);

	//Antiaims load
	Clientvariables->Antiaim.AntiaimEnable = ReadInt(("AntiAim"), ("Enable"), 0);
	Clientvariables->Antiaim.Indicator = ReadInt(("AntiAim"), ("Indicator"), 0);
	Clientvariables->Antiaim.Lines = ReadInt(("AntiAim"), ("Lines"), 0);
	...
	Clientvariables->Antiaim.breakaa = ReadInt(("AntiAim"), ("breakaa"), 0);
	...
	Clientvariables->Visuals.Radar = ReadInt(("Visuals"), ("Radar"), 0);
	...
	Clientvariables->Visuals.ChamsL = ReadInt(("Visuals"), ("Lplayer"), 0);
	...
	Clientvariables->Colors.Props = ReadInt(("Visuals"), ("asusprops"), 0);
	Clientvariables->Visuals.crosssnip = ReadInt(("Visuals"), ("crosssnip"), 0);
	...
	//Clientvariables->Visuals.ShowBacktrack = ReadInt(("Miscellaneous"), ("BacktrackVisual"), 0);
	...
	Clientvariables->Misc.WireHand = ReadInt(("Miscellaneous"), ("WireHand"), 0);
	Clientvariables->Misc.static_scope = ReadInt(("Miscellaneous"), ("static_scope"), 0);
	Clientvariables->Visuals.Spectators = ReadInt(("Visuals"), ("Spectators"), 0);

	Clientvariables->Colors.MenuColor[0] = ReadFloat(("Colors"), ("MenuR"), 255);
	Clientvariables->Colors.MenuColor[1] = ReadFloat(("Colors"), ("MenuG"), 255);
	Clientvariables->Colors.MenuColor[2] = ReadFloat(("Colors"), ("MenuB"), 255);

	Clientvariables->Colors.Glow[0] = ReadFloat(("Colors"), ("GlowR"), 255);
	Clientvariables->Colors.Glow[1] = ReadFloat(("Colors"), ("GlowG"), 255);
	Clientvariables->Colors.Glow[2] = ReadFloat(("Colors"), ("GlowB"), 255);
	Clientvariables->Colors.Glow[3] = ReadFloat(("Colors"), ("GlowA"), 255);

	Clientvariables->Colors.Skeletons[0] = ReadFloat(("Colors"), ("BonesR"), 255);
	Clientvariables->Colors.Skeletons[1] = ReadFloat(("Colors"), ("BonesG"), 255);
	Clientvariables->Colors.Skeletons[2] = ReadFloat(("Colors"), ("BonesB"), 255);

	Clientvariables->Colors.BoundingBox[0] = ReadFloat(("Colors"), ("BoxR"), 55.f);
	Clientvariables->Colors.BoundingBox[1] = ReadFloat(("Colors"), ("BoxG"), 255);
	Clientvariables->Colors.BoundingBox[2] = ReadFloat(("Colors"), ("BoxB"), 255);

	Clientvariables->Colors.PlayerChams[0] = ReadFloat(("Colors"), ("ChamsPlayerR"), 255.f);
	Clientvariables->Colors.PlayerChams[1] = ReadFloat(("Colors"), ("ChamsPlayerG"), 255);
	Clientvariables->Colors.PlayerChams[2] = ReadFloat(("Colors"), ("ChamsPlayerB"), 255);

	Clientvariables->Colors.PlayerChamsWall[0] = ReadFloat(("Colors"), ("ChamsNONR"), 255);
	Clientvariables->Colors.PlayerChamsWall[1] = ReadFloat(("Colors"), ("ChamsNONG"), 255);
	Clientvariables->Colors.PlayerChamsWall[2] = ReadFloat(("Colors"), ("ChamsNONB"), 255);


	Clientvariables->Colors.SpreadCrosshair[0] = ReadFloat(("Colors"), ("SpreadR"), 255);
	Clientvariables->Colors.SpreadCrosshair[1] = ReadFloat(("Colors"), ("SpreadG"), 255);
	Clientvariables->Colors.SpreadCrosshair[2] = ReadFloat(("Colors"), ("SpreadB"), 255);
	Clientvariables->Colors.SpreadCrosshair[3] = ReadFloat(("Colors"), ("SpreadA"), 255);


	Clientvariables->Colors.Bulletracer[0] = ReadFloat(("Colors"), ("TracersR"), 255);
	Clientvariables->Colors.Bulletracer[1] = ReadFloat(("Colors"), ("TracersG"), 255);
	Clientvariables->Colors.Bulletracer[2] = ReadFloat(("Colors"), ("TracersB"), 255);

	Clientvariables->Colors.ChamsHistory[0] = ReadFloat(("Colors"), ("ChamsHistoryR"), 255);
	Clientvariables->Colors.ChamsHistory[1] = ReadFloat(("Colors"), ("ChamsHistoryG"), 255);
	Clientvariables->Colors.ChamsHistory[2] = ReadFloat(("Colors"), ("ChamsHistoryB"), 255);
}
...
void Config::Reset()
{
	...
	Clientvariables->Colors.Props = 0;
	Clientvariables->Visuals.crosssnip = 0;
	...
	Clientvariables->Ragebot.headaimwalking = 0;
	...
	Clientvariables->Antiaim.breakaa = 0;
	...
	Clientvariables->Visuals.ChamsL = 0;
	...
	//	Clientvariables->Visuals.ShowBacktrack = 0;
	...
	Clientvariables->Colors.MenuColor[0] = ReadFloat(("Colors"), ("MenuR"), 255);
	Clientvariables->Colors.MenuColor[1] = ReadFloat(("Colors"), ("MenuG"), 255);
	Clientvariables->Colors.MenuColor[2] = ReadFloat(("Colors"), ("MenuB"), 255.f);
	...
	Clientvariables->Colors.Skeletons[0] = ReadFloat(("Colors"), ("BonesR"), 255);
	Clientvariables->Colors.Skeletons[1] = ReadFloat(("Colors"), ("BonesG"), 24.f);
	Clientvariables->Colors.Skeletons[2] = ReadFloat(("Colors"), ("BonesB"), 255);

	Clientvariables->Colors.BoundingBox[0] = ReadFloat(("Colors"), ("BoxR"), 255);
	Clientvariables->Colors.BoundingBox[1] = ReadFloat(("Colors"), ("BoxG"), 255);
	Clientvariables->Colors.BoundingBox[2] = ReadFloat(("Colors"), ("BoxB"), 255);

	Clientvariables->Colors.PlayerChams[0] = ReadFloat(("Colors"), ("ChamsPlayerR"), 255);
	Clientvariables->Colors.PlayerChams[1] = ReadFloat(("Colors"), ("ChamsPlayerG"), 255);
	Clientvariables->Colors.PlayerChams[2] = ReadFloat(("Colors"), ("ChamsPlayerB"), 255);
