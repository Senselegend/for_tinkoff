...

{
	...
	const float psh = Clientvariables->Ragebot.Headscale / 100;
	const float psb = Clientvariables->Ragebot.Bodyscale / 100;
	switch (iHitbox) {
...
static bool GameUtils::isVisible(CBaseEntity* lul, int bone)
{
	Ray_t ray;
	trace_t tr;
